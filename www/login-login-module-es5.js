  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppLoginLoginPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var LoginPage = /*#__PURE__*/function () {
        function LoginPage(_AppService, _UserService) {
        ...
        _createClass(LoginPage, [{
          key: "user_login",
          value: function user_login(form) {
            var _this = this;
            ...
            this._AppService.post_data("auth/login", {
              ...
              console.log(res); // alert(1+JSON.stringify(res))
              ...
              if (res.status == 1) {
                ...
                _this._AppService.router_navigation('/home');
              }
            }, function (error) {
              ...
              if (error.status == 401) {
                _this.errorMessage = 'البريد الإلكتروني أو كلمة المرور خطأ';
              }
            });
          }
        }, {
