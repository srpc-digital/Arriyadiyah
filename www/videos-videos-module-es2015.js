...
let VideosPage = class VideosPage {
    ...
    get_data() {
        this._AppService.get_data(`app_news_by_sections/5?page=${this.index}`, 'r').subscribe((res) => {
            this.data = this.data.concat(res.results.section_5);
    ...
    ngOnInit() {
        ...
        this.get_data();
        // this._AppService.infinite_scroll('.infinite_box')
    }
};
...
VideosPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-videos',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! raw-loader!./videos.page.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/videos/videos.page.html")).default,
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(/*! ./videos.page.scss */ "./src/app/videos/videos.page.scss")).default]
    })
], VideosPage);
