(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["matches-matches-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppMatchesMatchesPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function srcAppMatchesMatchesRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "MatchesPageRoutingModule", function () {
        return MatchesPageRoutingModule;
      });
      /* harmony import */
      ...
      var _matches_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./matches.page */
      ...
      var MatchesPageRoutingModule = function MatchesPageRoutingModule() {
        _classCallCheck(this, MatchesPageRoutingModule);
      };

      MatchesPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    function srcAppMatchesMatchesModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "MatchesPageModule", function () {
      ...
      var _matches_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./matches-routing.module */
      "./src/app/matches/matches-routing.module.ts");
      /* harmony import */


      var _matches_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./matches.page */
      "./src/app/matches/matches.page.ts");
      /* harmony import */
      ...
      var MatchesPageModule = function MatchesPageModule() {
        _classCallCheck(this, MatchesPageModule);
      };

      MatchesPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _matches_routing_module__WEBPACK_IMPORTED_MODULE_5__["MatchesPageRoutingModule"], _shared_shared_components__WEBPACK_IMPORTED_MODULE_7__["SharedComponentsModule"]],
    ...
    /***/
    function srcAppMatchesMatchesPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppMatchesMatchesPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "MatchesPage", function () {
        return MatchesPage;
      });
      /* harmony import */
      ...
      var MatchesPage = /*#__PURE__*/function () {
        function MatchesPage(_AppService, _ElementRef, _UserService) {
          ...
          this.slideOpts = {
            ...
            slidesPerView: 5,
            centeredSlides: true,
            spaceBetween: 10 // paginationClickable: true,
            // preventClicks:true
            // dynamicBullets:true
        ...
        _createClass(MatchesPage, [{
          ...
          value: function get_data(day) {
            ...
            this._AppService.get_data("matches?date=".concat(day), 's') // this._AppService.get_data(`match/list?date=${day}`, 's')
            .subscribe(function (res) {
              _this.data = res;
              console.log(_this.data);

              if (_this.data.data.matches.length > 0) {
                _this._competitions = _this.data.data.matches;
                _this._matches = _this.data.data.matches.matches;
              } else {
                _this.no_matches = true;
              }

              _this.page_loaded = true; // console.log(this._matches)
          ...
          value: function generate_days() {
            ...
            var now = new Date(); // -- before 30 days
            ...
            for (var _i = 1; _i < 30; _i++) {
              this.days_arr.push(new Date(now.getTime() + _i * 86400000));
            } // console.log(this.days_arr)
            // -- inject


            for (var _i2 = 0; _i2 < this.days_arr.length; _i2++) {
              this.edited.push({
                "fulldate": "".concat(this.days_arr[_i2].getFullYear(), "/").concat(this.days_arr[_i2].getMonth() + 1, "/").concat(this.days_arr[_i2].getDate()),
                "day": "".concat(this.months_arabic[this.days_arr[_i2].getMonth()]),
                "month": "".concat(this.days_arr[_i2].getDate())
              });
            }
            ...
            this.edited[30].month = ''; // console.log(this.edited)

            this.get_data(this.date_today);
          }
        }, {
          key: "click",
          value: function click(el, day, index) {
          ...
          key: "days_scroll",
          value: function days_scroll() {
            // console.log(this._ElementRef.nativeElement.querySelector('.calenday-days'))
            var all = this._ElementRef.nativeElement.querySelectorAll('.calenday-days__day');

            this._ElementRef.nativeElement.querySelectorAll('.calenday-days__day')[29].classList.add('active'); // console.log(this._ElementRef.nativeElement.querySelectorAll('.calenday-days__day')[29])
          ...
          value: function ngOnInit() {
            ...
            this.generate_days(); // this.days_scroll()
          }
        }]);
      ...
      MatchesPage.ctorParameters = function () {
        return [{
      ...
      MatchesPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-matches',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./matches.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/matches/matches.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./matches.page.scss */
        "./src/app/matches/matches.page.scss"))["default"]]
      })], MatchesPage);
      /***/
    }
  }]);
