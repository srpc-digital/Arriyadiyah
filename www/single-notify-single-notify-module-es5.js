(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["single-notify-single-notify-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppSingleNotifySingleNotifyPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppSingleNotifySingleNotifyRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SingleNotifyPageRoutingModule", function () {
        return SingleNotifyPageRoutingModule;
      });
      /* harmony import */
      ...
      var _single_notify_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./single-notify.page */
      ...
      var SingleNotifyPageRoutingModule = function SingleNotifyPageRoutingModule() {
        _classCallCheck(this, SingleNotifyPageRoutingModule);
      };

      SingleNotifyPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppSingleNotifySingleNotifyModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SingleNotifyPageModule", function () {
        return SingleNotifyPageModule;
      });
      /* harmony import */
      ...
      var _single_notify_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./single-notify-routing.module */
      "./src/app/single-notify/single-notify-routing.module.ts");
      /* harmony import */


      var _single_notify_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./single-notify.page */
      "./src/app/single-notify/single-notify.page.ts");
      /* harmony import */
      ...
      var SingleNotifyPageModule = function SingleNotifyPageModule() {
        _classCallCheck(this, SingleNotifyPageModule);
      };

      SingleNotifyPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _single_notify_routing_module__WEBPACK_IMPORTED_MODULE_5__["SingleNotifyPageRoutingModule"], _shared_shared_components__WEBPACK_IMPORTED_MODULE_7__["SharedComponentsModule"]],
    ...
    /***/
    function srcAppSingleNotifySingleNotifyPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppSingleNotifySingleNotifyPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SingleNotifyPage", function () {
        return SingleNotifyPage;
      });
      /* harmony import */
      ...
      var SingleNotifyPage = /*#__PURE__*/function () {
        function SingleNotifyPage(_AppService, _ActivatedRoute, _Router) {
          _classCallCheck(this, SingleNotifyPage);
        ...
        _createClass(SingleNotifyPage, [{
          key: "recieve_data",
          value: function recieve_data() {
            var _this = this;

            this._AppService.getPostDataForNotify(this.id).subscribe(function (data) {
              console.log("data from api : ".concat(data['results']['title']));
              _this.title = data['results']['title'];
              _this.img = data['results']['img'];
              _this.text = data['results']['text'];
              _this.date = data['results']['date'];
              _this.author = data['results']['author']; // localStorage.clear();

              _this._removed_rn = _this.text.replace(/(?:\r\n|\r|\n)/g, '<br>');
              _this._after = _this._removed_rn.replace(/&quot;/g, ' ');
          ...
          value: function related_news() {
            ...
            this._AppService.get_data("app_news_by_sections/58", 'r').subscribe(function (res) {
              console.log(res);
              _this2.data_loaded = true;
              _this2._trends = res.results.section_58;
            });
          }
        }, {
          key: "get_images",
          value: function get_images() {
            ...
            this._AppService.get_data("app_images_by_news_id/".concat(this.id), 'r').subscribe(function (res) {
              _this3.images_loading = false;
              console.log(res);

              if (res != null) {
                _this3.article_images = res.results;
              }
            });
          }
        }, {
      ...
      SingleNotifyPage.ctorParameters = function () {
        return [{
      ...
      SingleNotifyPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-single-notify',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./single-notify.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/single-notify/single-notify.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./single-notify.page.scss */
        "./src/app/single-notify/single-notify.page.scss"))["default"]]
      })], SingleNotifyPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=single-notify-single-notify-module-es5.js.map