(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["player-player-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPlayerPlayerPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPlayerPlayerRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPlayerPlayerModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPlayerPlayerPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPlayerPlayerPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var PlayerPage = /*#__PURE__*/function () {
        function PlayerPage(_ActivatedRoute, _AppService, _ElementRef) {
          _classCallCheck(this, PlayerPage);

          this._ActivatedRoute = _ActivatedRoute;
          this._AppService = _AppService;
          this._ElementRef = _ElementRef;
          this.data_loaded = false; // _team_statistics
        ...
        _createClass(PlayerPage, [{
          ...
          value: function get_details() {
            ...
            this._AppService.get_data("player/details?playerId=".concat(this.id), 's').subscribe(function (res) {
              _this.data = res.data; // console.log(this.data)

              _this._memberships = _this.data.memberships; // this._staistics = this.data.
              ...
              for (var i = 0; i < _this.data.club_unique.length; i++) {
                _this.played_arr.push({
                  "team_name": _this.data.club_unique[i].teamName,
                  "team_id": _this.data.club_unique[i].teamId
                });
              }

              _this.played_arr.push({
                "team_name": _this.data.nationality_team.teamArea,
                "team_id": _this.data.nationality_team.teamId
              });

              console.log(_this.played_arr);

              _this.get_statistics(_this.data.club_unique[0].teamId, '', false);
            });
          }
        }, {
          key: "get_statistics",
          value: function get_statistics(_teamId, _seasonId, team_changed) {
            var _this2 = this;

            var competitions;

            this._AppService.get_data("player/statistic?playerId=".concat(this.id, "&seasonId=").concat(_seasonId, "&teamId=").concat(_teamId), 's').subscribe(function (res) {
              _this2.statistics_data = res.data.competitions_statistic;
              console.log(_this2.statistics_data);
              competitions = res.data.competitions_Season; // console.log(competitions)

              if (team_changed) {
                _this2.competitions_arr = [];
              }

              for (var i = 0; i < competitions.length; i++) {
                // console.log(competitions[i].name)
                for (var x = 0; x < competitions[i].seasons.length; x++) {
                  _this2.competitions_arr.push({
                    "competition_name": "".concat(competitions[i].name, " - ").concat(competitions[i].seasons[x].title),
          ...
          value: function tabs(index) {
            ...
            setTimeout(function () {
              _this3._AppService.scroll_to_top();
            }, 10);
          }
        }, {
          key: "_router",
          ...
          value: function ngOnInit() {
            ...
            this.get_details(); // this.get_statistics()
          }
        }]);
      ...
      PlayerPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/player/player.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./player.page.scss */
        "./src/app/player/player.page.scss"))["default"]]
      })], PlayerPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=player-player-module-es5.js.map