...
let MorePage = class MorePage {
    constructor(_UserService, _AppService) {
        this._UserService = _UserService;
        this._AppService = _AppService;
    }
    logout() {
        this._AppService.user_post_data(`auth/logout`, { "device_id": localStorage.getItem('device_id'), "device_type": this._AppService.get_platform() }, 's', localStorage.getItem('token'))
            .subscribe((res) => {
    ...
    ngOnInit() {
        this.isUserLogged = this._UserService.is_user_logged(false);
    }
};
