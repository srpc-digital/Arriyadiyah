(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["competition-competition-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppCompetitionCompetitionPageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppCompetitionCompetitionRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CompetitionPageRoutingModule", function () {
        return CompetitionPageRoutingModule;
      });
      /* harmony import */
      ...
      var _competition_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./competition.page */
      ...
      var CompetitionPageRoutingModule = function CompetitionPageRoutingModule() {
        _classCallCheck(this, CompetitionPageRoutingModule);
      };

      CompetitionPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppCompetitionCompetitionModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CompetitionPageModule", function () {
      ...
      var _competition_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./competition-routing.module */
      "./src/app/competition/competition-routing.module.ts");
      /* harmony import */


      var _competition_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./competition.page */
      "./src/app/competition/competition.page.ts");
      /* harmony import */
      ...
      var CompetitionPageModule = function CompetitionPageModule() {
        _classCallCheck(this, CompetitionPageModule);
      };

      CompetitionPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _competition_routing_module__WEBPACK_IMPORTED_MODULE_5__["CompetitionPageRoutingModule"], _shared_shared_components__WEBPACK_IMPORTED_MODULE_7__["SharedComponentsModule"]],
    ...
    /***/
    function srcAppCompetitionCompetitionPageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppCompetitionCompetitionPageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "CompetitionPage", function () {
      ...
      var CompetitionPage = /*#__PURE__*/function () {
        function CompetitionPage(_ActivatedRoute, _AppService, _ElementRef, _UserService) {
          _classCallCheck(this, CompetitionPage);
        ...
        _createClass(CompetitionPage, [{
          key: "get_matches",
          value: function get_matches(_id, _week, _round) {
            var _this = this;

            this.matches_loaded = false;

            this._AppService.get_data("Competitions/matches?week=".concat(_week, "&roundId=").concat(_round, "&id=").concat(_id), 's').subscribe(function (res) {
              _this.matches_loaded = true;
              _this.data = res.data;
              _this._matches = res.data.matches;
              _this.data_loaded = true;

              if (_this._matches.length == 0) {
              ...
              console.log(_this._matches);

              if (_this.data.format != 'domestic_league') {
                _this._total_rounds = _this.data.rounds;
                console.log(_this._total_rounds);
              } else {
                _this.sum_weeks();
              }
            });
          ...
          key: "sum_weeks",
          value: function sum_weeks() {
            this._total_weeks = [];

            for (var i = 1; i < this.data.week_count + 1; i++) {
          ...
          key: "get_standing",
          value: function get_standing() {
            var _this2 = this;

            this.standing_loaded = false;

            this._AppService.get_data("Competitions/table?competitionId=".concat(this.id), 's').subscribe(function (res) {
              console.log(res.data.groups);

              if (res.data.format != 'domestic_league') {
                _this2._standing = res.data.groups;
              } else {
                _this2._standing = res.data.table;
              }

              console.log(_this2._standing);

              if (_this2._standing.length == 0) {
          ...
          key: "get_top_scorers",
          value: function get_top_scorers() {
            var _this3 = this;

            this.top_scorers_loaded = false;

            this._AppService.get_data("Competitions/topScorer?competitionId=".concat(this.id), 's').subscribe(function (res) {
              console.log(res);
              _this3._top_scorers = res.data.topScorer;
          ...
          key: "get_stastistics",
          value: function get_stastistics() {
            var _this4 = this;

            this.statistics_loaded = false;

            this._AppService.get_data("Competitions/statistic?competitionId=".concat(this.id), 's').subscribe(function (res) {
              console.log(res);
              _this4._statistics = res.data;
              _this4._top_Team_scoreFor = _this4._statistics.top_Team_scoreFor;
              _this4._top_Team_Aganst = _this4._statistics.top_Team_Aganst;
              _this4._top_Team_Yellowcards = _this4._statistics.top_Team_Yellowcards;
              _this4._top_Team_Redcards = _this4._statistics.top_Team_Redcards;
            });
          }
        }, {
          key: "back",
            ...
            if (this.if_user_logged) {
              this._AppService.user_get_data("user/favourite", 's', localStorage.getItem('token')).subscribe(function (res) {
                ...
                if (res.data.length > 0) {
                  _this5.favorites_competitions = res.data.favorite_competitions;

                  for (var i = 0; i < _this5.favorites_competitions.length; i++) {
                    if (_this5.favorites_competitions[i].competitionId == _this5.id) {
      ...
      CompetitionPage.ctorParameters = function () {
        return [{
      ...
      CompetitionPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-competition',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./competition.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/competition/competition.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./competition.page.scss */
        "./src/app/competition/competition.page.scss"))["default"]]
      })], CompetitionPage);
      /***/
    }
  }]);
})();
//# sourceMappingURL=competition-competition-module-es5.js.map